...
public class PackageNameFragmentActivity extends Activity {
    ...
    public static class AppListFragment extends ListFragment implements
        ...
        class ChioceClickListener implements DialogInterface.OnMultiChoiceClickListener {
        ...
        protected Dialog getMultiSelectDialog(int id) {
            ...
            switch (id) {
                case 0: {
                    ...
                    builder.setMultiChoiceItems(values, checkedItems, new ChioceClickListener());
                    builder.setPositiveButton("ok", new OkClickListener());
                    builder.setNegativeButton("cancel", new CancelClickListener());
